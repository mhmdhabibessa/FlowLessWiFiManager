...
#define VER_IDF_STR WM_STRING(ESP_IDF_VERSION_MAJOR) \
"." WM_STRING(ESP_IDF_VERSION_MINOR) "." WM_STRING(ESP_IDF_VERSION_PATCH)
#endif
...
#define VER_ARDUINO_STR WM_STRING(ESP_ARDUINO_VERSION_MAJOR) \
"." WM_STRING(ESP_ARDUINO_VERSION_MINOR) "." WM_STRING(ESP_ARDUINO_VERSION_PATCH)
#else
// #include <core_version.h>
